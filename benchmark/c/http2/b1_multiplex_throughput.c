...
int main(int argc, char** argv)
{
    ...
    if (galay_c_runtime_create(&runtime_config, &runtime) != C_RuntimeSuccess ||
        ...
        galay_c_coro_spawn(&runtime, server_entry, &bench, 0, &server_task).code != C_IOResultOk ||
        galay_c_coro_spawn(&runtime, client_entry, &bench, 0, &client_task).code != C_IOResultOk ||
