...
foreach(required_source_path
        IN ITEMS
        "src/galay-kernel/core/runtime.h"
        "src/galay-kernel/core/task.h"
        "src/galay-kernel/common/error.h"
        "src/galay-utils/cache/ring_buffer.hpp"
        "src/galay-http/client/http_client.h"
        "src/galay-mcp/server/stdio_server.h")
...
if(NOT root_cmake_content MATCHES "install\\(DIRECTORY[ \t\r\n]+\\$\\{PROJECT_SOURCE_DIR\\}/src/")
    message(FATAL_ERROR "CMake must directly install headers from PROJECT_SOURCE_DIR/src/.")
endif()
...
target_include_directories(consumer BEFORE PRIVATE "${CMAKE_PREFIX_PATH}/include")
