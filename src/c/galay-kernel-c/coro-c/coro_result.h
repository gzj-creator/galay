#ifndef GALAY_C_KERNEL_CORO_RESULT_H
#define GALAY_C_KERNEL_CORO_RESULT_H
 ...
 * @brief C 协程和 I/O 结果码。
 *
 * @details Ok/Eof/Timeout/Cancelled/Invalid/Error/Closed 覆盖 direct C coroutine I/O
 * 与 channel 操作。具体函数会在自己的注释中说明哪些字段有效。
 */
typedef enum C_IOResultCode {
    ...
    C_IOResultClosed       ///< Channel 或资源已关闭。
} C_IOResultCode;
