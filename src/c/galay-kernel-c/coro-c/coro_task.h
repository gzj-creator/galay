#ifndef GALAY_C_KERNEL_CORO_TASK_H
#define GALAY_C_KERNEL_CORO_TASK_H
 ...
 * @brief 不透明 C 协程任务句柄。
 */
typedef struct galay_c_coro_task {
    void* task;
} galay_c_coro_task_t;
 ...
 * @note 任务由 C runtime 的 IO scheduler 调度。
 */
 ...
 * @param task `galay_c_coro_spawn` 返回的任务句柄。
 ...
 */
C_IOResult galay_c_coro_join(galay_c_coro_task_t* task, int64_t timeout_ms);
 ...
 */
C_IOResult galay_c_coro_destroy(galay_c_coro_task_t* task);

#ifdef __cplusplus
}
#endif

#endif // GALAY_C_KERNEL_CORO_TASK_H
