...
namespace galay::redis
{
    namespace detail
    {
        ...
        static bool parseRepliesFromRingBuffer(galay::utils::RingBuffer<galay::utils::RingBufferBackendStrategy::Mmap, std::dynamic_extent>& ring_buffer,
    ...
    namespace detail
    {
        ...
        std::expected<bool, RedisError> RedissExchangeMachine::tryParseReplies()
        {
            ...
            const bool done = parseRepliesFromRingBuffer(*m_state->impl->ring_buffer,
                                                         m_state->impl->parser,
