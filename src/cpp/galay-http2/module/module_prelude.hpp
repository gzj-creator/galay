...
#endif
#if __has_include("../client/h2_client.h")
#include "../client/h2_client.h"
#endif
#if __has_include("../client/h2c_client.h")
#include "../client/h2c_client.h"
#endif
#if __has_include("../kernel/http2_conn.h")
#include "../kernel/http2_conn.h"
#endif
#if __has_include("../server/http2_server.h")
#include "../server/http2_server.h"
#endif
#if __has_include("../kernel/http2_stream.h")
#include "../kernel/http2_stream.h"
#endif
#if __has_include("../kernel/stream_manager.h")
...
#endif
#if __has_include("../protoc/http2_base.h")
#include "../protoc/http2_base.h"
#endif
#if __has_include("../protoc/http2_error.h")
#include "../protoc/http2_error.h"
#endif
#if __has_include("../protoc/http2_frame.h")
#include "../protoc/http2_frame.h"
#endif
#if __has_include("../builder/http2_frame_builder.h")
#include "../builder/http2_frame_builder.h"
#endif
#if __has_include("../protoc/http2_hpack.h")
#include "../protoc/http2_hpack.h"
#endif
#if __has_include("../utils/h2_helper.h")
