...
- import 版本示例位于 `examples/cpp/http/mcpp/`
- 模块 smoke test 位于 `test/t59_module.cpp`
- 后两者只在模块门禁全部满足时进入构建图

使用传统头文件时：

```cpp
#include <galay/cpp/galay-http/server/galay-http/http_server.h>
#include <galay/cpp/galay-http/client/websocket/ws_client.h>
```
