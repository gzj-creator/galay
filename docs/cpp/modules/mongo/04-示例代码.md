...
- include 版本：`examples/include/e1_ping.cc`
- include 版本：`examples/include/e2_ping.cc`
- include 版本：`examples/include/e3_crud.cc`
- include 版本：`examples/include/e4_pipeline.cc`
- include 版本：`examples/include/e5_command.cc`
- import 版本：`examples/cpp/mongo/mcpp/e1_ping.cc`
- import 版本：`examples/cpp/mongo/mcpp/e2_ping.cc`
- import 版本：`examples/cpp/mongo/mcpp/e3_crud.cc`
- import 版本：`examples/cpp/mongo/mcpp/e4_pipeline.cc`
- import 版本：`examples/cpp/mongo/mcpp/e5_command.cc`
...
Task<void> app(IOScheduler* scheduler, State* state, MongoConfig cfg) {
...
Task<void> run(IOScheduler* scheduler, State* state, MongoConfig cfg) {
    AsyncMongoClient client(scheduler);
...
```cpp
Task<void> handleQueryAsync(IOScheduler* scheduler) {
    AsyncMongoClient client(scheduler);
...
MongoDocument age_cond;
age_cond.append("$gte", int32_t(18));
match_filter.append("age", std::move(age_cond));
...
MongoDocument count_expr;
count_expr.append("$sum", int32_t(1));
group_spec.append("count", std::move(count_expr));
